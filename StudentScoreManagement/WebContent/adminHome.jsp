...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact GNI MUMBAI TEAM.
Designed & Developed by GNI MUMBAI Team</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ GNI MUMBAI :: 2015-2020</h5></center> 
  <hr class="new1">
<br>
</body>
</html>